<%-- 
    Document   : validate
    Created on : Sep 5, 2020, 5:11:16 AM
    Author     : mac
--%>
...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <title>FynGram Shop - Password Recovery</title>
    ...
    <body>
        ...
        <jsp:include page="../../../../WEB-INF/static_pages/user/general/validate/validate.jsp"></jsp:include>
