<%-- 
    Document   : address
    Created on : Jun 16, 2020, 1:38:04 PM
    Author     : Pinky
--%>
...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <title>FynGram Shop - My Address</title>
    ...
    <body>
        ...
        <jsp:include page="../../../../WEB-INF/static_pages/user/customer/address/address.jsp"></jsp:include>
