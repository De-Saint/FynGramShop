<%-- 
    Document   : returns
    Created on : Jun 16, 2020, 1:44:59 PM
    Author     : Pinky
--%>
...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <title>FynGram Shop - My Order Returns</title>
    ...
    <body>
        ...
        <jsp:include page="../../../../WEB-INF/static_pages/user/customer/returns/returns.jsp"></jsp:include>
        ...
        <script src="returns.js" type="text/javascript"></script>
