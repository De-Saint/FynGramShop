<%-- 
    Document   : messages
    Created on : Jun 16, 2020, 1:40:10 PM
    Author     : Pinky
--%>
...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <title>FynGram Shop - My Messages</title>
    ...
    <body>
        ...
        <jsp:include page="../../../../WEB-INF/static_pages/user/customer/messages/messages.jsp"></jsp:include>
