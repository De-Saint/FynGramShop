<%-- 
    ...
    Created on : Jun 16, 2020, 1:47:54 PM
    Author     : Pinky
--%>
...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <title>FynGram Shop - My Transactions</title>
    ...
    <body>
        ...
        <jsp:include page="../../../../WEB-INF/static_pages/user/customer/transaction/transaction.jsp"></jsp:include>
