<%-- 
    Document   : reviews
    Created on : Jun 16, 2020, 1:46:35 PM
    Author     : Pinky
--%>
...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <title>FynGram Shop - My Reviews</title>
    ...
    <body>
        ...
        <jsp:include page="../../../../WEB-INF/static_pages/user/customer/reviews/reviews.jsp"></jsp:include>
