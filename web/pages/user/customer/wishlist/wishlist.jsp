<%-- 
    Document   : wishlist
    Created on : Jun 16, 2020, 1:50:14 PM
    Author     : Pinky
--%>
...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <title>FynGram Shop - My Wishlist</title>
    ...
    <body>
        ...
        <jsp:include page="../../../../WEB-INF/static_pages/user/customer/wishlist/wishlist.jsp"></jsp:include>
