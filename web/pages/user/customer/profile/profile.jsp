<%-- 
    Document   : profile
    Created on : Jun 16, 2020, 1:44:39 PM
    Author     : Pinky
--%>
...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <title>FynGram Shop - My Profile</title>
    ...
    <body>
        ...
        <jsp:include page="../../../../WEB-INF/static_pages/user/customer/profile/profile.jsp"></jsp:include>
