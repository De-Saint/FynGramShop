<%-- 
    Document   : payment
    Created on : Jun 16, 2020, 1:42:52 PM
    Author     : Pinky
--%>
...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <title>FynGram Shop - My Payments</title>
    ...
    <body>
        ...
        <jsp:include page="../../../../WEB-INF/static_pages/user/customer/payment/payment.jsp"></jsp:include>
