<%-- 
    Document   : cashout
    Created on : Jun 29, 2020, 6:58:48 PM
    Author     : Pinky
--%>
...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <title>FynGram Shop - My Cashout Requests</title>
        ...
        <link href="cashout.css" rel="stylesheet" type="text/css"/>
        <!-- Main Style CSS -->
    ...
    <body>
        ...
        <jsp:include page="../../../../WEB-INF/static_pages/user/customer/cashout/cashout.jsp"></jsp:include>
        ...
        <script src="cashout.js" type="text/javascript"></script>
