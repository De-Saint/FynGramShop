<%-- 
    Document   : wallet
    Created on : Jun 16, 2020, 1:49:41 PM
    Author     : Pinky
--%>
...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <title>FynGram Shop - FynPay Account</title>
    ...
    <body>
        ...
        <jsp:include page="../../../../WEB-INF/static_pages/user/customer/wallet/wallet.jsp"></jsp:include>
