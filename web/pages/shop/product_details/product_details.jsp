<%-- 
    ...
    Created on : Jun 18, 2020, 2:34:57 AM
    Author     : mac
--%>
...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <title>FynGram Shop - Product Details</title>
    ...
    <body>
        ...
        <jsp:include page="../../../WEB-INF/static_pages/shop/product_details/product_details.jsp"></jsp:include>
