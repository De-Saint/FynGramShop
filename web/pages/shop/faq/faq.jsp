<%-- 
    Document   : faq
    Created on : Jun 16, 2020, 1:55:52 PM
    Author     : Pinky
--%>
...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <title>FynGram Shop - Frequently Asked Questions</title>
    ...
    <body>
        ...
        <jsp:include page="../../../WEB-INF/static_pages/shop/faq/faq.jsp"></jsp:include>
