<%-- 
    ...
    Created on : Aug 1, 2020, 11:50:25 PM
    Author     : mac
--%>
...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <title>FynGram Shop - Order Confirmation</title>
    ...
    <body>
        ...
        <jsp:include page="../../../WEB-INF/static_pages/shop/order_confirm/order_confirm.jsp"></jsp:include>
