<%-- 
    Document   : returned_policy
    Created on : Aug 6, 2020, 7:10:54 AM
    Author     : Pinky
--%>
...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <title>FynGram Shop - New Feature Suggestion</title>
    ...
    <body>
        ...
        <jsp:include page="../../../WEB-INF/static_pages/shop/returned_policy/returned_policy.jsp"></jsp:include>
