<%-- 
    Document   : how_to_return
    Created on : Aug 6, 2020, 7:02:38 AM
    Author     : Pinky
--%>
...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <title>FynGram Shop - How To Return A Product</title>
    ...
    <body>
        ...
        <jsp:include page="../../../WEB-INF/static_pages/shop/how_to_return/how_to_return.jsp"></jsp:include>
